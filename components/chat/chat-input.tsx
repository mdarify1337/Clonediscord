...
export default function ChatInput({
    ...
    const form = useForm<z.infer<typeof fomrShema>>({
        resolver: zodResolver(fomrShema),
        defaultValues: {
            content: ""
        }
    })
    ...
    const onSubmit = async (value: z.infer<typeof fomrShema>)  => {
        try {
                            ...
                            <FormControl>
                                <div className="relative p-4 pb-6">
                                    ...
                                    <Input 
                                        ...
                                        text-zinc-600 dark:text-zinc-200 font-semibold"
